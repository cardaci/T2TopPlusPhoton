#ifndef RecoPhotonSelectionAntiElectronVeto_H
#define RecoPhotonSelectionAntiElectronVeto_H
...
void RecoPhotonSelectionAntiElectronVeto(LepInfoBranches LepInfo, PhotonInfoBranches PhotonInfo, 
