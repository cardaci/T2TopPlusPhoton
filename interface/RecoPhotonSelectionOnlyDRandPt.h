#ifndef RecoPhotonSelectionOnlyDRandPt_H
#define RecoPhotonSelectionOnlyDRandPt_H
...
void RecoPhotonSelectionOnlyDRandPt(LepInfoBranches LepInfo, PhotonInfoBranches PhotonInfo, 
