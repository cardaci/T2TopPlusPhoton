#ifndef RecoLeptonSelection_forEfficiency_H
#define RecoLeptonSelection_forEfficiency_H
...
void RecoLeptonSelection_forEfficiency(EvtInfoBranches EvtInfo, LepInfoBranches LepInfo, int &NMuons, int *M_Index, int &NElectrons, int *E_Index,
