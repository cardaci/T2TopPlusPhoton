...
struct sample_t SAMPLE[samples_order_size] = {
    //{"./REDUCE_DATA/PhotonData/1lepton4jets_*_Run2012*198934-203002*.root",
    {"./REDUCE_DATA/PhotonData/1lepton4jets_*_Run2012*.root",
    //{"./REDUCE_DATA/PhotonData/1lepton4jets_*_Run2012*193752-196531*.root",
    //{"./REDUCE_DATA/PhotonData/1lepton4jets_*_Run2012*.root",
        "data", LUMINOSITY , 1 , 0},
