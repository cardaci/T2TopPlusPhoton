#ifndef RecoLeptonSelectionNoElectronPt_H
#define RecoLeptonSelectionNoElectronPt_H
...
void RecoLeptonSelectionNoElectronPt(EvtInfoBranches EvtInfo, LepInfoBranches LepInfo, int &NMuons, int *M_Index, int &NElectrons, int *E_Index,
