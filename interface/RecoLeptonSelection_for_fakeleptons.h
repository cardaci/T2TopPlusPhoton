#ifndef RecoLeptonSelection_for_fakeleptons_H
#define RecoLeptonSelection_for_fakeleptons_H
...
void RecoLeptonSelection_for_fakeleptons(EvtInfoBranches EvtInfo, LepInfoBranches LepInfo, int &NMuons, int *M_Index, int &NElectrons, int *E_Index,
