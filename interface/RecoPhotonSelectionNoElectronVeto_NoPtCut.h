#ifndef RecoPhotonSelectionNoElectronVeto_NoPtCut_H
#define RecoPhotonSelectionNoElectronVeto_NoPtCut_H
...
void RecoPhotonSelectionNoElectronVeto_NoPtCut(LepInfoBranches LepInfo, PhotonInfoBranches PhotonInfo, 
