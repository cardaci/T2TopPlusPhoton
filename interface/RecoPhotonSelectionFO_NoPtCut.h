#ifndef RecoPhotonSelectionFO_NoPtCut_H
#define RecoPhotonSelectionFO_NoPtCut_H
...
void RecoPhotonSelectionFO_NoPtCut(LepInfoBranches LepInfo, PhotonInfoBranches PhotonInfo, 
