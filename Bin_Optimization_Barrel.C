...
void Bin_Optimization_Barrel(){ 
    ...
    h_Numerator_Quark_PT =(TH1F*) f1->Get("Numerator_Quark_PT_Barrel");
    ...
    h_Denominator_Gluon_PT =(TH1F*) f1->Get("Denominator_Gluon_PT_Barrel");
    ...
    h_Numerator_Gluon_PT =(TH1F*) f1->Get("Numerator_Gluon_PT_Barrel");
