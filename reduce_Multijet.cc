...
void reduce_Multijet()
{
do_reduce("MultiJet_Run2012A-22Jan2013-v1_190645-193621");

do_reduce("JetHT_Run2012B-22Jan2013-v1_193834-194833"); 
do_reduce("JetHT_Run2012B-22Jan2013-v1_194834-195833"); 
}
...
{      
	...
	*/
	...
	if(!( NPhotons_FO >= 1 || NPhotons >= 1 )) continue;
