...
*/
    ...
    float Barrel_Quark_Background_counter[5][5][5][5];
    float Endcap_Quark_Background_counter[5][5][5][5];
    float Barrel_Gluon_Background_counter[5][5][5][5];
    float Endcap_Gluon_Background_counter[5][5][5][5];

    float Barrel_Quark_ISR_counter[5][5][5][5];
    float Endcap_Quark_ISR_counter[5][5][5][5];
    float Barrel_Gluon_ISR_counter[5][5][5][5];
    float Endcap_Gluon_ISR_counter[5][5][5][5];

    float Barrel_Quark_FSR_counter[5][5][5][5];
    float Endcap_Quark_FSR_counter[5][5][5][5];
    float Barrel_Gluon_FSR_counter[5][5][5][5];
    float Endcap_Gluon_FSR_counter[5][5][5][5];


    float Barrel_Quark_Signal_counter[5][5][5][5];
    float Endcap_Quark_Signal_counter[5][5][5][5];
    float Barrel_Gluon_Signal_counter[5][5][5][5];
    float Endcap_Gluon_Signal_counter[5][5][5][5];



    float Barrel_Quark_Background_squared_weight[5][5][5][5];
    float Endcap_Quark_Background_squared_weight[5][5][5][5];
    float Barrel_Gluon_Background_squared_weight[5][5][5][5];
    float Endcap_Gluon_Background_squared_weight[5][5][5][5];

    float Barrel_Quark_ISR_squared_weight[5][5][5][5];
    float Endcap_Quark_ISR_squared_weight[5][5][5][5];
    float Barrel_Gluon_ISR_squared_weight[5][5][5][5];
    float Endcap_Gluon_ISR_squared_weight[5][5][5][5];

    float Barrel_Quark_FSR_squared_weight[5][5][5][5];
    float Endcap_Quark_FSR_squared_weight[5][5][5][5];
    float Barrel_Gluon_FSR_squared_weight[5][5][5][5];
    float Endcap_Gluon_FSR_squared_weight[5][5][5][5];


    float Barrel_Quark_Signal_squared_weight[5][5][5][5];
    float Endcap_Quark_Signal_squared_weight[5][5][5][5];
    float Barrel_Gluon_Signal_squared_weight[5][5][5][5];
    float Endcap_Gluon_Signal_squared_weight[5][5][5][5];
               ...
               for(int l=0;l<5 ;l++) {
                 ...
                 Barrel_Quark_Background_counter[i][j][k][l]=0.;
                 Endcap_Quark_Background_counter[i][j][k][l]=0.;
                 Barrel_Gluon_Background_counter[i][j][k][l]=0.;
                 Endcap_Gluon_Background_counter[i][j][k][l]=0.;

                 Barrel_Quark_ISR_counter[i][j][k][l]=0.;
                 Endcap_Quark_ISR_counter[i][j][k][l]=0.;
                 Barrel_Gluon_ISR_counter[i][j][k][l]=0.;
                 Endcap_Gluon_ISR_counter[i][j][k][l]=0.;

                 Barrel_Quark_FSR_counter[i][j][k][l]=0.;
                 Endcap_Quark_FSR_counter[i][j][k][l]=0.;
                 Barrel_Gluon_FSR_counter[i][j][k][l]=0.;
                 Endcap_Gluon_FSR_counter[i][j][k][l]=0.;

                 Barrel_Quark_Signal_counter[i][j][k][l]=0.;
                 Endcap_Quark_Signal_counter[i][j][k][l]=0.;
                 Barrel_Gluon_Signal_counter[i][j][k][l]=0.;
                 Endcap_Gluon_Signal_counter[i][j][k][l]=0.;




                 Barrel_Quark_Background_squared_weight[i][j][k][l]=0.;
                 Endcap_Quark_Background_squared_weight[i][j][k][l]=0.;
                 Barrel_Gluon_Background_squared_weight[i][j][k][l]=0.;
                 Endcap_Gluon_Background_squared_weight[i][j][k][l]=0.;

                 Barrel_Quark_ISR_squared_weight[i][j][k][l]=0.;
                 Endcap_Quark_ISR_squared_weight[i][j][k][l]=0.;
                 Barrel_Gluon_ISR_squared_weight[i][j][k][l]=0.;
                 Endcap_Gluon_ISR_squared_weight[i][j][k][l]=0.;

                 Barrel_Quark_FSR_squared_weight[i][j][k][l]=0.;
                 Endcap_Quark_FSR_squared_weight[i][j][k][l]=0.;
                 Barrel_Gluon_FSR_squared_weight[i][j][k][l]=0.;
                 Endcap_Gluon_FSR_squared_weight[i][j][k][l]=0.;

                 Barrel_Quark_Signal_squared_weight[i][j][k][l]=0.;
                 Endcap_Quark_Signal_squared_weight[i][j][k][l]=0.;
                 Barrel_Gluon_Signal_squared_weight[i][j][k][l]=0.;
                 Endcap_Gluon_Signal_squared_weight[i][j][k][l]=0.;
	    ...
	    for(int g=0;g<NPhotons_FO;g++) { // loop on FO photons
	      ...
	      for(int j=0;j<NJets;j++) { // loop on jets
	        ...
	        if(dR_aux < 0.5 /*&& NJets >=4*/){
		     ...
		     PhotonInfo.hadTowOverEm[P_Index_FO[g]] > 2 * i * 0.01 &&
		          ...
		          if( JetInfo.QGTagsLikelihood[J_Index[jindex]] > 0.9){ // Quark-like
  			        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Barrel_Quark_Background_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Barrel_Quark_Signal_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Barrel_Quark_ISR_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Barrel_Quark_FSR_counter[i][j][k][l] += set_of_weights[sample_index];

  			        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Barrel_Quark_Background_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Barrel_Quark_Signal_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Barrel_Quark_ISR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Barrel_Quark_FSR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];

			  }
                          if( JetInfo.QGTagsLikelihood[J_Index[jindex]] < 0.9 && JetInfo.QGTagsLikelihood[J_Index[jindex]] >= 0.){ // Gluon-like
			        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Barrel_Gluon_Background_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Barrel_Gluon_Signal_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Barrel_Gluon_ISR_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Barrel_Gluon_FSR_counter[i][j][k][l] += set_of_weights[sample_index];

			        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Barrel_Gluon_Background_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Barrel_Gluon_Signal_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Barrel_Gluon_ISR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Barrel_Gluon_FSR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
			  }
			}
			...
			if(fabs(PhotonInfo.Eta[P_Index_FO[g]])< 2.4 && fabs(PhotonInfo.Eta[P_Index_FO[g]])>= 1.566){//Endcap
		          if( JetInfo.QGTagsLikelihood[J_Index[jindex]] > 0.9){ // Quark-like
   	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Endcap_Quark_Background_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Endcap_Quark_Signal_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Endcap_Quark_ISR_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Endcap_Quark_FSR_counter[i][j][k][l] += set_of_weights[sample_index];

   	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Endcap_Quark_Background_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Endcap_Quark_Signal_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Endcap_Quark_ISR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Endcap_Quark_FSR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];

			  }
                          if( JetInfo.QGTagsLikelihood[J_Index[jindex]] < 0.9 && JetInfo.QGTagsLikelihood[J_Index[jindex]] >= 0.){ // Gluon-like
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Endcap_Gluon_Background_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Endcap_Gluon_Signal_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Endcap_Gluon_ISR_counter[i][j][k][l] += set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Endcap_Gluon_FSR_counter[i][j][k][l] += set_of_weights[sample_index];

	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==1)  ) Endcap_Gluon_Background_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==0)  ) Endcap_Gluon_Signal_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==2)  ) Endcap_Gluon_ISR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
	                        if( (dR_aux2 != 0.5) && (GenInfo.PhotonFlag[mindex]==3)  ) Endcap_Gluon_FSR_squared_weight[i][j][k][l] += set_of_weights[sample_index]*set_of_weights[sample_index];
			  }
			}
               ...
               /*
               float optimal_fraction_Barrel_Quark = 100000000000;
               int i_optimal_fraction_Barrel_Quark = 100;
               int j_optimal_fraction_Barrel_Quark = 100;
               int k_optimal_fraction_Barrel_Quark = 100;
               int l_optimal_fraction_Barrel_Quark = 100;

               float optimal_fraction_Barrel_Gluon = 100000000000;
               int i_optimal_fraction_Barrel_Gluon = 100;
               int j_optimal_fraction_Barrel_Gluon = 100;
               int k_optimal_fraction_Barrel_Gluon = 100;
               int l_optimal_fraction_Barrel_Gluon = 100;

               float optimal_fraction_Endcap_Quark = 100000000000;
               int i_optimal_fraction_Endcap_Quark = 100;
               int j_optimal_fraction_Endcap_Quark = 100;
               int k_optimal_fraction_Endcap_Quark = 100;
               int l_optimal_fraction_Endcap_Quark = 100;

               float optimal_fraction_Endcap_Gluon = 100000000000;
               int i_optimal_fraction_Endcap_Gluon = 100;
               int j_optimal_fraction_Endcap_Gluon = 100;
               int k_optimal_fraction_Endcap_Gluon = 100;
               int l_optimal_fraction_Endcap_Gluon = 100;
	       */
		 ...
		 if ((Barrel_Quark_Background_counter[i][j][k][l]+Barrel_Quark_ISR_counter[i][j][k][l]+Barrel_Quark_FSR_counter[i][j][k][l]) > 0){
		    ...
		    /*
		    if(Barrel_Quark_Signal_counter[i][j][k][l]/(Barrel_Quark_Background_counter[i][j][k][l]+Barrel_Quark_ISR_counter[i][j][k][l]+Barrel_Quark_FSR_counter[i][j][k][l]) < optimal_fraction_Barrel_Quark) optimal_fraction_Barrel_Quark = Barrel_Quark_Signal_counter[i][j][k][l]/(Barrel_Quark_Background_counter[i][j][k][l]+Barrel_Quark_ISR_counter[i][j][k][l]+Barrel_Quark_FSR_counter[i][j][k][l]);
                    i_optimal_fraction_Barrel_Quark = i;
                    j_optimal_fraction_Barrel_Quark = j;
                    k_optimal_fraction_Barrel_Quark = k;
                    l_optimal_fraction_Barrel_Quark = l;
		    */
		 }
		 ...
		 if ((Barrel_Gluon_Background_counter[i][j][k][l]+Barrel_Gluon_ISR_counter[i][j][k][l]+Barrel_Gluon_FSR_counter[i][j][k][l]) > 0){
		    ...
		    /*
		    if(Barrel_Gluon_Signal_counter[i][j][k][l]/(Barrel_Gluon_Background_counter[i][j][k][l]+Barrel_Gluon_ISR_counter[i][j][k][l]+Barrel_Gluon_FSR_counter[i][j][k][l]) < optimal_fraction_Barrel_Gluon) optimal_fraction_Barrel_Gluon = Barrel_Gluon_Signal_counter[i][j][k][l]/(Barrel_Gluon_Background_counter[i][j][k][l]+Barrel_Gluon_ISR_counter[i][j][k][l]+Barrel_Gluon_FSR_counter[i][j][k][l]);
                    i_optimal_fraction_Barrel_Gluon = i;
                    j_optimal_fraction_Barrel_Gluon = j;
                    k_optimal_fraction_Barrel_Gluon = k;
                    l_optimal_fraction_Barrel_Gluon = l;
		    */
		 }
		 ...
		 if ((Endcap_Quark_Background_counter[i][j][k][l]+Endcap_Quark_ISR_counter[i][j][k][l]+Endcap_Quark_FSR_counter[i][j][k][l]) > 0){
		    ...
		    /*
		    if(Endcap_Quark_Signal_counter[i][j][k][l]/(Endcap_Quark_Background_counter[i][j][k][l]+Endcap_Quark_ISR_counter[i][j][k][l]+Endcap_Quark_FSR_counter[i][j][k][l]) < optimal_fraction_Endcap_Quark) optimal_fraction_Endcap_Quark = Endcap_Quark_Signal_counter[i][j][k][l]/(Endcap_Quark_Background_counter[i][j][k][l]+Endcap_Quark_ISR_counter[i][j][k][l]+Endcap_Quark_FSR_counter[i][j][k][l]);
                    i_optimal_fraction_Endcap_Quark = i;
                    j_optimal_fraction_Endcap_Quark = j;
                    k_optimal_fraction_Endcap_Quark = k;
                    l_optimal_fraction_Endcap_Quark = l;
		    */
		 }
		 ...
		 if ((Endcap_Gluon_Background_counter[i][j][k][l]+Endcap_Gluon_ISR_counter[i][j][k][l]+Endcap_Gluon_FSR_counter[i][j][k][l]) > 0){
		    ...
		    /*
		    if(Endcap_Gluon_Signal_counter[i][j][k][l]/(Endcap_Gluon_Background_counter[i][j][k][l]+Endcap_Gluon_ISR_counter[i][j][k][l]+Endcap_Gluon_FSR_counter[i][j][k][l]) < optimal_fraction_Endcap_Gluon) optimal_fraction_Endcap_Gluon = Endcap_Gluon_Signal_counter[i][j][k][l]/(Endcap_Gluon_Background_counter[i][j][k][l]+Endcap_Gluon_ISR_counter[i][j][k][l]+Endcap_Gluon_FSR_counter[i][j][k][l]);
                    i_optimal_fraction_Endcap_Gluon = i;
                    j_optimal_fraction_Endcap_Gluon = j;
                    k_optimal_fraction_Endcap_Gluon = k;
                    l_optimal_fraction_Endcap_Gluon = l;
		    */
		 }
		 ...
		 if ((Barrel_Gluon_Background_counter[i][j][k][l]+Barrel_Gluon_ISR_counter[i][j][k][l]+Barrel_Gluon_FSR_counter[i][j][k][l]) > 0 &&
	       ...
	       /*
		 cout << "optimal_fraction_Barrel_Quark: " << optimal_fraction_Barrel_Quark << endl;
		 cout << "i_optimal_fraction_Barrel_Quark: " << i_optimal_fraction_Barrel_Quark << endl;
		 cout << "j_optimal_fraction_Barrel_Quark: " << j_optimal_fraction_Barrel_Quark << endl;
		 cout << "k_optimal_fraction_Barrel_Quark: " << k_optimal_fraction_Barrel_Quark << endl;
		 cout << "l_optimal_fraction_Barrel_Quark: " << l_optimal_fraction_Barrel_Quark << endl;
                 cout << "--------------------------------------------" << endl;
                 cout << "--------------------------------------------" << endl;
                 cout << "--------------------------------------------" << endl;
		 cout << "optimal_fraction_Barrel_Gluon: " << optimal_fraction_Barrel_Gluon << endl;
		 cout << "i_optimal_fraction_Barrel_Gluon: " << i_optimal_fraction_Barrel_Gluon << endl;
		 cout << "j_optimal_fraction_Barrel_Gluon: " << j_optimal_fraction_Barrel_Gluon << endl;
		 cout << "k_optimal_fraction_Barrel_Gluon: " << k_optimal_fraction_Barrel_Gluon << endl;
		 cout << "l_optimal_fraction_Barrel_Gluon: " << l_optimal_fraction_Barrel_Gluon << endl;
                 cout << "--------------------------------------------" << endl;
                 cout << "--------------------------------------------" << endl;
                 cout << "--------------------------------------------" << endl;
		 cout << "optimal_fraction_Endcap_Quark: " << optimal_fraction_Endcap_Quark << endl;
		 cout << "i_optimal_fraction_Endcap_Quark: " << i_optimal_fraction_Endcap_Quark << endl;
		 cout << "j_optimal_fraction_Endcap_Quark: " << j_optimal_fraction_Endcap_Quark << endl;
		 cout << "k_optimal_fraction_Endcap_Quark: " << k_optimal_fraction_Endcap_Quark << endl;
		 cout << "l_optimal_fraction_Endcap_Quark: " << l_optimal_fraction_Endcap_Quark << endl;
                 cout << "--------------------------------------------" << endl;
                 cout << "--------------------------------------------" << endl;
                 cout << "--------------------------------------------" << endl;
		 cout << "optimal_fraction_Endcap_Quark: " << optimal_fraction_Endcap_Quark << endl;
