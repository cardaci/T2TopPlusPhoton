...
void reduce_DoubleMuon_low_pT_muons()
{
do_reduce("DoubleMuParked_Run2012A-22Jan2013-v1_190645-193621");

do_reduce("DoubleMuParked_Run2012B-22Jan2013-v1_195834-196531");
do_reduce("DoubleMuParked_Run2012B-22Jan2013-v1_193834-194833");
}
...
{      
    ...
    char buffer[1024];
    string sample_style_ = "reduce_low_pT_muons";
	...
	*/        
	...
	if(!( NMuons == 2 && LepInfo.Pt[M_Index[0]] > 20 && (NPhotons_NO_ELECTRON_VETO==1 || NPhotons_FO ==1) )) continue;
