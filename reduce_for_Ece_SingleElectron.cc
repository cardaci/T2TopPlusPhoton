...
#include "interface/RecoPhotonSelectionFONoPt.h"              
...
void reduce_for_Ece_SingleElectron()
{
do_reduce("SingleElectron_Run2012A-22Jan2013-v1_190645-193621");

do_reduce("SingleElectron_Run2012B-22Jan2013-v1_195834-196531");
do_reduce("SingleElectron_Run2012B-22Jan2013-v1_193834-194833");
}
...
{      
    ...
    char buffer[1024];
    string sample_style_ = "reduce_for_Ece";
	...
	*/
	...
	if(!( NElectrons >= 1 && NPhotons_NO_ELECTRON_VETO >= 1 )) continue;
